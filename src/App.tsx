...
// Dashboard Component
const Dashboard = ({ equipment, inspections, onDeleteEquipment }: { 
  equipment: Equipment[], 
    ...
    <Router>
      <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-cyan-600">
        ...
        <main className="container mx-auto px-6 py-8">
          <Routes>
            <Route path="/" element={<Dashboard equipment={equipment} inspections={inspections} onDeleteEquipment={deleteEquipment} />} />
